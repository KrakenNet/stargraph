...
"""Tool smith ledger — the shared :class:`Ledger` bound to ``TOOLSMITH_HOME``.

All behavior lives in :mod:`stargraph.skills._smith.ledger`; this module binds it
to the tool smith's home (default ``.stargraph/toolsmith``) and exposes the
...
_LEDGER = Ledger(home_env="TOOLSMITH_HOME", home_default=".stargraph/toolsmith")
