...
"""ML smith ledger — the shared :class:`Ledger` bound to ``MLSMITH_HOME``.

All behavior lives in :mod:`stargraph.skills._smith.ledger`; this module binds it
to the ML smith's home (default ``.stargraph/mlsmith``) and exposes the methods as
...
_LEDGER = Ledger(home_env="MLSMITH_HOME", home_default=".stargraph/mlsmith")
