...
"""Graph smith ledger — the shared :class:`Ledger` bound to ``GRAPHSMITH_HOME``.

All behavior lives in :mod:`stargraph.skills._smith.ledger`; this module binds it
to the graph smith's home (default ``.stargraph/graphsmith``) and exposes the
...
_LEDGER = Ledger(home_env="GRAPHSMITH_HOME", home_default=".stargraph/graphsmith")
