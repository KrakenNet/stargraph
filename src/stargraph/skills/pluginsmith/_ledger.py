...
"""Plugin smith ledger — the shared :class:`Ledger` bound to ``PLUGINSMITH_HOME``.

All behavior lives in :mod:`stargraph.skills._smith.ledger`; this module binds it
to the plugin smith's home (default ``.stargraph/pluginsmith``) and exposes the
...
_LEDGER = Ledger(home_env="PLUGINSMITH_HOME", home_default=".stargraph/pluginsmith")
