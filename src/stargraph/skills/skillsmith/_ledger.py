...
"""Skill smith ledger — the shared :class:`Ledger` bound to ``SKILLSMITH_HOME``.

All behavior lives in :mod:`stargraph.skills._smith.ledger`; this module binds it
to the skill smith's home (default ``.stargraph/skillsmith``) and exposes the
...
_LEDGER = Ledger(home_env="SKILLSMITH_HOME", home_default=".stargraph/skillsmith")
