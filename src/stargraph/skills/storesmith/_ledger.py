...
"""Store smith ledger — the shared :class:`Ledger` bound to ``STORESMITH_HOME``.

All behavior lives in :mod:`stargraph.skills._smith.ledger`; this module binds it
to the store smith's home (default ``.stargraph/storesmith``) and exposes the
...
_LEDGER = Ledger(home_env="STORESMITH_HOME", home_default=".stargraph/storesmith")
