...
:data:`stargraph.runtime.Event` per line to a file opened with
...
class ChainedJSONLAuditSink:
    ...
    nautilus / stargraph) via :class:`fathom.chained_log.ChainedAttestationLog`:
    ...
    (``stargraph verify-audit``). The signing public key is exported beside
