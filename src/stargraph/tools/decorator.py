...
Binds a Python callable to a :class:`stargraph.ir._models.ToolSpec`. The returned
...
def tool(
    *,
    ...
    def decorate(fn: Callable[..., Any]) -> Callable[..., Any]:
        # Lazy ToolSpec import: see stargraph.tools.__init__ docstring for the
        # circular-import rationale (stargraph.ir._models imports our enums).
