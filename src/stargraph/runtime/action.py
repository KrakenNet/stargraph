...
Foundation's :func:`stargraph.fathom.extract_actions` produces a list of typed IR
:data:`Action` instances from CLIPS ``stargraph_action`` fact slot dicts, including
